  ...
  message.channel
    .send(
      new Discord.RichEmbed()
        .setColor("AQUA")
        .setTitle("📊 LOG.BOT Sıralama")
        .setDescription("LeaderBoard Ayarlansın mı ?")
        .setFooter('Onaylıyorsan 10 saniye içerisinde "evet" yazmalısın.')
    )
    .then(() => {
      message.channel
        ...
        .then(collected => {
          ...
          try {
            ...
            message.guild.createChannel(`📊 LOG.BOT Sıralama`, "category", [
              ...
              .then(channel =>
                channel.setParent(
                  message.guild.channels.find(
                    channel => channel.name === `📊 LOG.BOT Sıralama`
                  )
                )
              )
              .then(c => {
